...
if prompt:
    ...
    # dense vector
    dense_query = embeddings.embed_query(prompt)

    # sparse vector
    sparse_query = bm25.encode_queries([prompt])[0]
    ...
    docs_text = "\n\n---\n\n".join(match["metadata"]["text"] for match in docs["matches"])
